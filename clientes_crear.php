                    ...
                    <form id="formulario_cliente" class="form-horizontal" method="post" action="return false" onsubmit="return false">
                        ...
                        <div class="row justify-content-center mb-3">
                            <div class="col-sm-8 ps-4 align-self-center">
                                <button id="btn_enviar" onclick="Agregar();" class="btn btn-danger col-sm-12"><i class="bi bi-person-plus"></i> Guardar</button>
                            </div>
                        </div>
            ...
            closeAnimation: 'zoom',
                ...
                btnClass: 'btn-danger',
                    action: function(){
                        ...
                        beforeSend: function () {
                            $("#resp").html("<img src='imagenes/load.gif' width='30px' height='30px'/><font color='white'>&nbspProcesando, espere...</font>");
                        },
