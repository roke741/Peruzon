...
<head>
    ...
    <title>Peruzon-Productos-Crear</title>
    <!--bootstrap-->
    ...
    <div class="container-fluid">
        <div class="row" style="height: 100vh;">
            ...
            <div class="col-9 panel">
                <h2 class="fw-bold fst-italic text-center text-light pt-3">CREAR PRODUCTO</h2>
                <br>
                ...
                <div class="container"> 
                    <form id="formulario_producto" class="form-horizontal" method="post" action="return false" onsubmit="return false">
                        ...
                        <div class="row mb-3 align-items-center text-end">
                            ...
                            <div class="col-sm-8 ps-4">
                                <input id="precio_compra" class="form-control" type="number" name="precio_compra" value="<?php echo $precio_compra ?>" size="20" maxlength="20" >
                            </div>
                        </div>
                        <div class="row mb-3 align-items-center text-end">
                            <label for="precio_final" class="col-sm-2 col-form-label">Precio Final:</label>
                            <div class="col-sm-8 ps-4">
                                <input id="precio_final" class="form-control" type="number" name="precio_final" value="<?php echo $precio_final ?>" size="20" maxlength="20" >
                            </div>
                        </div>

                        <div class="row justify-content-center mb-3">
                            <div class="col-sm-8 ps-4 align-self-center">
                                <button id="btn_enviar" onclick="AgregarProducto();" class="btn btn-danger col-sm-12"><i class="bi bi-save2"></i> Guardar</button>
                            </div>
                        </div>
