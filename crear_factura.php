...
<head>
    ...
    <title>Peruzon-Crear Facturas-Cliente</title>
    <!--bootstrap-->
					...
					<form name='frmSearch' action='' method='post'>
						...
						<div class="row justify-content-start mb-1">
							<div class="col-6 d-flex">
								<p class="btn-agregar px-2"><a href="buscar_productos.php">Agregar Productos</a></p>
							</div>
						</div>
						...
						<div class="table-responsive">
                            <table class="table table-danger table-bordered  table-hover">
								...
								<tr>
									...
									<td><?php echo number_format($_SESSION['carrito'][$nro_reglon]['precio'],2,',','.') ?></td>
									<td><?php echo number_format($_SESSION['carrito'][$nro_reglon]['cantidad']*$_SESSION['carrito'][$nro_reglon]['precio'],2,',','.'); ?></td>
						...
						<div class="container">
							<div class="table-responsive">
								...
								<tr>	
									<td>
										<div align="right">
											<button class="btn  btn-success" type="submit" name="submit" style="font-family: Arial; font-size: 12pt;"><b>Total:</b></button>
										</div>
									</td>	
									<td>
										<div align="right">
								...
								<br><br>
								<div>
									Nro. de productos: <?php echo number_format($cantidad2,0,',','.'); ?>
								</div>
							</div>
						</div>

						<button class="btn btn-success" type="submit" name="submit2" style="font-family: Arial; font-size: 12pt;"><b>Guardar</b></button>
						<br><br>

						<b><span class="encab">Ver factura en otra moneda: </span></b><select name="pass" id="pass"><?php echo $combobit2;?></select>
						<button class="btn btn-success" type="submit" name="submit3" style="font-family: Arial; font-size: 12pt;"><b>Vista</b></button></p>
