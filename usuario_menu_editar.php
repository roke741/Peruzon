...
<head>
    ...
    <title>Peruzon-Usuario-Editar</title>
    ...
    <div class="container-fluid">
        <div class="row" style="height: 100vh;">
            ...
            <div class="col-9 panel">
                <h2 class="fw-bold fst-italic text-center text-light pt-3">EDITAR USUARIO</h2>
                <br>
                    ...
                    <form id="formulario_usuario_crear" class="form-horizontal" method="post" action="return false" onsubmit="return false">
                        ...
                        <div class="row justify-content-center mb-3">
                            <div class="col-sm-8 ps-4 align-self-center">
                                <button id="btn_enviar" class="btn btn-danger col-sm-12" onclick="Validar(document.getElementById('id_usuario').value, document.getElementById('usuario').value, document.getElementById('contrasena').value, document.getElementById('nombre').value, document.getElementById('rol').value);" >
            ...
            closeAnimation: 'zoom',
                ...
                btnClass: 'btn-danger',
                    action: function(){
                        ...
                        $.ajax({                                       
                        url: "usuario_menu_editar_validar.php",
                        type: "POST",        
