<!--buscar proveedores=comprar_proveedores-->
...
<head>
    ...
    <title>Peruzon-Proveedores-Lista</title>
    <!--bootstrap-->
    ...
    <div class="container-fluid">
        <div class="row" style="height: 100vh;">
            ...
            <div class="col-9 panel">
                <h2 class="fw-bold fst-italic text-center text-light pt-3">Proveedores Lista</h2>
                <br>
                ...
                $sql = 'SELECT * FROM tab_proveedores WHERE nombres LIKE :keyword OR apellidos LIKE :keyword OR dni_ruc LIKE :keyword ORDER BY nombres, apellidos ';
...
<!--<input type='text' name='search[keyword]' value="<?php echo $search_keyword; ?>" id='keyword' maxlength='25'>-->
                        ...
                        <div class="row justify-content-start mb-1">
                            <div class="col-6 d-flex">
                                <p class="btn-agregar px-2"><a href="proveedores_crear.php">Agregar Proveedor</a></p>
                            </div>
                        </div>
                            ...
                            <table class="table table-danger table-bordered  table-hover">
                                <thead class="table-dark">
                                    <tr>
                                        ...
                                        <th class='table-header' width='14%'>DNI O RUC</th>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-danger" href="proveedores_reporte.php?id_proveedor=<?php echo $row['id_proveedor']?>"><i class="bi bi-eye"></i> Vista</a>
                                            <a class="btn btn-danger" href="#" onclick="Validar3(<?php echo $row['id_proveedor'] ?>, '<?php echo $row['nombres'] ?>')"><i class="bi bi-pencil"></i> Editar</a>
                                            <a class="btn btn-danger" href="#" onclick="Validar4(<?php echo $row['id_proveedor']?>, '<?php echo $row['nombres'] ?>')"><i class="bi bi-x-octagon"></i> Eliminar</a>
                                            <a class="btn btn-danger" href="buscar_facturas_proveed.php?id_proveedor=<?php echo $row['id_proveedor'] ?>"><i class="bi bi-file-earmark-text"></i> Facturas</a>
