...
<head>
    ...
    <title>Peruzon - Reportes - Compras</title>
    <!--bootstrap-->
    ...
    <div class="container-fluid">
        <div class="row" style="height: 100vh;">
            <div class="col-3  align-self-center menu">
                ...
                <nav class="nav-menu py-4">
                    <ul class="nav flex-column text-center fw-bold text-light" >
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="reportes.php"><i class="bi bi-file-text"></i>  VOLVER</a> 
                        </li>
                    </ul>
                </nav>
            </div>
            ...
            <div class="col-9 panel">
                <h2 class="fw-bold fst-italic text-center text-light pt-3">REPORTES COMPRAS PRODUCTOS</h2>
                <br>
                ...
                <div class="container px-4 text-light fw-bold">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="fecha_inicial" name="fecha_inicial"  value="<?php echo $fecha_inicial ?>" size="20" maxlength="15" >
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="fecha_final" class="col-sm-2 col-form-label">Fecha Final:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="fecha_final" name="fecha_final" value="<?php echo $fecha_final ?>" size="20" maxlength="15">
                            <span>Ejemplo: 01-01-2020 </span>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary" onclick="BuscarReporte();">Reporte</button>
                    <div>&nbsp&nbsp</div>
