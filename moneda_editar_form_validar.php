...
if ($_POST["user"] == "") {
    ...
    echo "<script>location.href = 'moneda_editar_form.php?id_moneda=$id_moneda&moneda=$user&valor_cambio=$pass'</script>";    
	exit();
...
echo "<script>location.href = 'moneda_editar.php'</script>";	
