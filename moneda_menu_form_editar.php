...
<head>
    ...
    <title>Peruzon-Moneda-Menu-Editar</title>
    <!--bootstrap-->
    ...
    buttons: {
        confirm: {
            ...
            btnClass: 'btn-danger',
                action: function(){
                $.ajax({
                url: "moneda_menu_form_editar_validar.php",
                type: "POST",
                data: "user="+user+"&pass="+pass+"&idmoneda="+idmoneda,
                beforeSend: function () {
                    $("#resp").html("<img src='imagen/load.gif'  width='30px' height='30px' /><font color='green'>&nbsp&nbspProcesando, por favor espere...</font>");
                },
