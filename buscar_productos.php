            ...
            <div class="col-3  align-self-center menu">
                ...
                <nav class="nav-menu py-4">
                    <ul class="nav flex-column text-center fw-bold text-light" >
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="crear_factura.php"><i class="bi bi-box-seam"></i> VOLVER</a> 
                        </li>
                    </ul>
                </nav>
            </div>
                            ...
                            <table class="table table-danger table-bordered  table-hover">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="crear_factura.php?id_producto=<?php echo $row['id_producto']?>&producto=<?php echo $row['producto']?>&descripcion=<?php echo $row['descripcion']?>&precio_final=<?php echo $row['precio_final']?>&existencia=<?php echo $row['cantidad_existencia']?> ">Agregar</a></td>
