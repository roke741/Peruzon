...
<head>
    ...
    <title>Peruzon-Comprar-Proveedores-Lista</title>
    ...
    <div class="container-fluid">
        <div class="row" style="height: 100vh;">
            <div class="col-3  align-self-center menu">
                ...
                <nav class="nav-menu py-4">
                    <ul class="nav flex-column text-center fw-bold text-light" >
                        ...
                        <li class="nav-item">
                            <a class="nav-link disabled" href="#"><i class="bi bi-shop"></i> COMPRAS</a> 
                        </li>
            ...
            <div class="col-9 panel">
                <h2 class="fw-bold fst-italic text-center text-light pt-3">LISTA PROVEEDOR</h2>
                        ...
                        <div class="table-responsive">
                            <table class="table table-danger table-bordered  table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="table-header" width="15%">DNI/RUC</th>
                                    <th class="table-header" width="15%">COMERCIO</th>
                                ...
                                <tbody id='table-body' style="white-space: nowrap;">
                                    ...
                                    <tr class="table-row">
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-danger p-1"><i class="bi bi-eye"></i> Vista</a> 
                                            <a href="#" class="btn btn-danger p-1"><i class="bi bi-pencil"></i> Editar</a> 
                                            <a href="#" class="btn btn-danger p-1"><i class="bi bi-x-octagon"></i> Eliminar</a> 
                                            <a href="#" class="btn btn-danger p-1"><i class="bi bi-file-earmark-text"></i> Facturas</a>
                                        </td>
                                    </tr>
                                    <?php
                                            }
